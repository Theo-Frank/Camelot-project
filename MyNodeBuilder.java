...
//Theo Frank
    ...
    public void atForestPath() {
        ...
        .add(new DialogSequence(player, Priest, 
                List.of("You see a priest standing quietly beside the path."),
                List.of("Talk with the Priest", "Ignore")));
    }
    @BuilderMethod
    ...
    public void giveSwordToPriest() {
        ...
        node.add(new HideDialog())
        	.add(new Give(player, sword, Priest))
